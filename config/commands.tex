...
\begin{itemize}
    ...
    \hspace*{1em} \begin{tabular}{>{\color{red}}l c r c p{10cm}}
	#1 & = & #2 & / & #3 \\
	\textcolor{gray}{Used in:}  & \multicolumn{4}{p{10cm}}{#4} \\
	\textcolor{gray}{Defined in:} & \multicolumn{4}{p{10cm}}{#5} \\
	\end{tabular}
\end{itemize}
}
...
\begin{itemize}
	...
	\hspace*{1em} \begin{tabular}{l p{12cm}}
	\textcolor{gray}{Used in:} & #4 \\
	\textcolor{gray}{Defined in:} & #5 \\
	\end{tabular}
