...
% To run cal\_extract\_RAW\_spirou type:
% \begin{lstlisting}[language=bash, style=bashstyle]
% cal_extract_RAW_spirou.py  night_repository  filename
% \end{lstlisting}
...
% \begin{lstlisting}[style=text]
% DRS_spirou -m cal_ 20170710 .fits
...
% \begin{figure}
% \begin{center}
% \includegraphics[width=.8\textwidth]{figures/cal_}
% \caption{\label{figure:cal_}}
% \end{center}
% \end{figure}
...
% \begin{lstlisting}[language=bash, style=bashstyle]
% cal_DRIFT_RAW_spirou.py  night_repository  filename
% \end{lstlisting}
