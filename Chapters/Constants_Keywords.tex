...
\noindent Note: This section is currently updated for `\caldark',`\calloc', `\calslit', `\calff', `\callext', `\callextall' only.
...
\ParamListCode{ic\_ccdx}{\lstinline[style=pythonstyle]{arange(5,2040)}}{Resize array for x}{\caldark, \calloc, \calslit, \calff, \callext, \callextall}{\caldark, \calloc, \calslit, \calff, \callext, \callextall, \hadmricdp}
% future ic_ccdx_low, ic_ccdx_high

\ParamListCode{ic\_ccdy}{\lstinline[style=pythonstyle]{arange(5,1935)}}{Resize array for y}{\caldark, \calloc, \calslit, \calff, \callext, \callextall}{\caldark, \calloc, \calslit, \calff, \callext, \callextall, \hadmricdp}
